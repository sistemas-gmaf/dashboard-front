...
const CARDS = [
  ...
  { title: 'Cheques del Mes', icon: RequestQuoteIcon, permiso: 'VER_INICIO_CHEQUES_PENDIENTES' },
  { title: 'Gastos del Mes', icon: ReceiptIcon, permiso: 'VER_INICIO_COMPROMISOS_PENDIENTES' },
