...
export default function Crear() {
  const apiClient = new ApiClient({ url: API.TARIFARIO_CLIENTES });
  let submitData = {};
  ...
  const handleSuccess = async (resetForm, response) => {
    ...
    const userConfirm = await Swal.fire({
      title: 'Hay un tarifario vigente para la zona/cliente/tipo-vehiculo seleccionados',
      html: `
